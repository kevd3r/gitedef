  ...
  return (
    <div className="min-h-screen bg-[#0C1824] text-white pt-20 pb-12">
      ...
      <Head>
        ...
        <meta
          name="description"
          content="Réservez votre hébergement directement avec notre calendrier interactif."
        />
                <link rel="icon" href="/favicon.ico" />     {" "}
      </Head>
           {" "}
      <div className="container mx-auto px-4 md:px-8 max_w-7xl justify-center">
                {/* Section Titre */}       {" "}
        ...
        <section className="bg-[#14273A] p-8 rounded-lg shadow-lg mb-16">
          <div>
            ...
            <div className="space-y-4 text-lg text-white">
                         {" "}
              <p>
                              Utilisez le calendrier ci-dessous pour vérifier la
                disponibilité et **sélectionner vos dates d&apos;arrivée et de
                départ** en cliquant et glissant.               Une fois vos
                dates choisies, remplissez le formulaire pour nous envoyer votre
              ...
              <p className="flex items-center text-blue-400 font-semibold mt-6">
                ...
                Sélectionnez vos dates d&apos;arrivée et de départ sur le
                calendrier.            {" "}
              </p>
                         {" "}
              ...
              <p className="flex items-center text-blue-400 font-semibold">
                ...
                Les dates sélectionnées apparaîtront automatiquement dans le
                formulaire.            {" "}
              </p>
                         {" "}
              <p className="flex items-center text-blue-400 font-semibold">
                             {" "}
                <BookOpenCheck className="inline-block mr-2 text-2xl" /> Nous
                vous confirmerons la réservation dans les plus brefs délais.    
                       {" "}
              </p>
            </div>
            {/* Intégration du DataFetcher et du Calendar */}
            <DataFetcher>
              {({ data }) => {
                // Filtrez pour ne garder que les réservations VALIDATED
